...
-   **src/**  - исходный код лаунчера и лаунчсервера (здесь находятся и собранные модули для лаунчсервера по пути src/modules/<НазваниеМодуля>_lmodule/build/libs/<НазваниеМодуля>_lmodule.jar)
