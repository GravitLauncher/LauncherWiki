...
**AuthCoreProvider** является интерфейсом лаунчсервера, позволяющего выполнить авторизацию пользователя через различные CMS
...
- ```launchserver.profile.00000000-0000-0000-0000-000000000000.*``` - разрешает показ в Лаунчере профиля и вход с конкретным uuid профиля (в нижнем регистре)
- ```launcher.runtime.optionals.00000000-0000-0000-0000-000000000000.*``` - разрешает управлять всеми опциональными модами в профиле с конкретным uuid
- ```launcher.runtime.optionals.00000000-0000-0000-0000-000000000000.sodium.show``` - разрешает видеть скрытый через ```limited``` поле опциональный мод: **Sodium** в профиле с конкретным uuid
