...
Для настройки большинства способов авторизации через БД вам необходимо указать passwordVerifier, соответствующий вашей CMS на сайте. (в данный момент указывать passwordVerifier в конфигурации не нужно, он пригодится вам немного позже)
